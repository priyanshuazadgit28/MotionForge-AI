...
function ProjectCard({
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col rounded-2xl overflow-hidden card-hover border animate-fade-in-up opacity-0"
      style={{
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
          <div
            className="flex size-14 items-center justify-center rounded-full backdrop-blur-sm transition-transform duration-200 group-hover:scale-110"
            style={{
      ...
      <div className="flex flex-col gap-2 p-3">
        <h3
          ...
          style={{ color: "oklch(0.90 0.005 285)" }}
        >
          {project.title}
        </h3>
        <p
          ...
          {showAuthor && project.author ? (
            <div className="flex items-center gap-1.5 min-w-0">
              ...
              <span
                ...
                style={{ color: "oklch(0.65 0.008 285)" }}
              >
                {project.author.name}
              </span>
              <span
                className="text-xs shrink-0"
                style={{ color: "oklch(0.40 0.006 285)" }}
              >
            ...
            <span
              className="text-xs"
              style={{ color: "oklch(0.45 0.006 285)" }}
            >
              {formatRelativeTime(project.createdAt)}
            </span>
          )}
  ...
  return (
    ...
    >
      ...
      <div className="mb-8 flex flex-col items-center gap-2 text-center">
        <div
          className="mb-2 inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold uppercase tracking-widest"
          style={{
            background: "oklch(0.65 0.22 285 / 0.10)",
            border: "1px solid oklch(0.65 0.22 285 / 0.20)",
        ...
        >
          {isLoggedIn
            ? "Your Created Videos"
            : "Made with MotionForge AI"}
        </h2>
        <p
          className="max-w-lg text-sm leading-relaxed"
          style={{ color: "oklch(0.55 0.010 285)" }}
        >
          {isLoggedIn
      ...
      {!isLoggedIn && projects.length > 0 && (
        <div className="mt-10 flex justify-center">
          <button
            id="load-more-button"
            type="button"
            className="inline-flex h-10 items-center gap-2 rounded-full px-6 text-sm font-semibold transition-all duration-200 hover:opacity-90 active:scale-95"
            style={{
              background: "oklch(0.17 0.016 285)",
              border: "1px solid oklch(1 0 0 / 0.08)",
              color: "oklch(0.75 0.010 285)",
            }}
          >
            Load More
          </button>
        ...
        >
          ...
          <div>
            <p
              ...
              style={{ color: "oklch(0.85 0.005 285)" }}
            >
              No projects yet
            </p>
            <p
